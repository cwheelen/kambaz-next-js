    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>
            Place chicken in a bag with marinade and refrigerate for 30 minutes
            to 4 hours.
          </li>
          <li>
            Cook marinated chicken over high heat until internal temperature
            reaches 155°F.
          </li>
          ...
          <li>
            Add chicken, peppers, onions, and cheese to a flour tortilla and
            fold in half.
          </li>
          <li>
            Cook in a frying pan with oil for 1 ½ minutes per side until golden
            brown.
          </li>
          <li>
            Remove, slice, and serve with guacamole, salsa, and sour cream.
          </li>
        </ol>
      </div>
      ...
      <div id="wd-forms">
        ...
        <br />
        Please
        <a href="https://github.com/cwheelen/web-dev-a1" id="github-repo">
          click here
        </a>
        for a github repo <br />
      </div>
    </div>
  );
}
